...
AuthM::User.create(email:"root@a.com", password:"asd12345", password_confirmation:"asd12345", roles: [:root], active: true)
...
resource_1 = management_1.resources.create(name: "User")

user_management_1.policies.create(resource_id: resource_1.id, access: "read")
